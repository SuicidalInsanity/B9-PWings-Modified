    ...
    public static class UIUtility
    {
        ...
        public static string GetValueTranslation(float value, int type)
        {
            ...
            else if (type == 2)
            {
                ...
                else if (value == 4f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000142");		// #autoLOC_B9_Aerospace_WingStuff_1000140 = Vee
                else if (value == 5f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000140");       // #autoLOC_B9_Aerospace_WingStuff_1000142 = Rounded
                else if (value == 6f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000143");		// #autoLOC_B9_Aerospace_WingStuff_1000143 = Triangular
                else if (value == 7f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000144");       // #autoLOC_B9_Aerospace_WingStuff_1000144 =  Rounded Biconcave
                else if (value == 8f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000144b");       // #autoLOC_B9_Aerospace_WingStuff_1000144 = Biconcave
                else if (value == 9f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000134");       // #autoLOC_B9_Aerospace_WingStuff_1000134 = Standard
                ...
                else if (value == 11f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000145");		// #autoLOC_B9_Aerospace_WingStuff_1000145 = Bevel
                ...
                else if (value == 13f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000146");      // #autoLOC_B9_Aerospace_WingStuff_1000146 = Half round
                ...
                else if (value == 15f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000146b");	    // #autoLOC_B9_Aerospace_WingStuff_1000146 = Concave
            ...
            else if (type == 3)
            {
                ...
                else if (value == 4f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000140");       // #autoLOC_B9_Aerospace_WingStuff_1000144 = Rounded
                ...
                else if (value == 6f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000144");       // #autoLOC_B9_Aerospace_WingStuff_1000144 = Biconcave
                else if (value == 7f) return Localizer.Format("#autoLOC_B9_Aerospace_WingStuff_1000134");       // #autoLOC_B9_Aerospace_WingStuff_1000134 = Standard
